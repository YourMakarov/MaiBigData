...
Выполнил Макаров Глеб М8О-209СВ-24

Как запускать на windows через jit bash:

1) docker-compose up -d

2) Подождать 1-2 мин

3) MSYS_NO_PATHCONV=1 docker exec -it bigdataspark-spark-master-1 spark-submit --master spark://spark-master:7077 --conf spark.jars.ivy=/tmp/.ivy --jars /opt/bitnami/spark/extra_jars/postgresql-42.7.4.jar,/opt/bitnami/spark/extra_jars/clickhouse-jdbc-0.6.4.jar /code/etl_star.py

4) MSYS_NO_PATHCONV=1 docker exec -it bigdataspark-spark-master-1 spark-submit --master spark://spark-master:7077 --conf spark.jars.ivy=/tmp/.ivy --jars /opt/bitnami/spark/extra_jars/postgresql-42.7.4.jar,/opt/bitnami/spark/extra_jars/clickhouse-jdbc-0.6.4.jar --driver-class-path /opt/bitnami/spark/extra_jars/clickhouse-jdbc-0.6.4.jar /code/reports_clickhouse.py
